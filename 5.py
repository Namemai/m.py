...
k5 = LINE()
k5.log("Auth Token : " + str(ke.authToken))
k5.log("Timeline Token : " + str(ke.tl.channelAccessToken))
...
keMID = k5.profile.mid
keProfile = k5.getProfile()
keSettings = k5.getSettings()
