...
settings = {
    ...
    "pname": {},
    "pro_name": {},
    "message":"บัญชีนี้ได้การป้องกันโดย SAMURIBOT ระบบได้ทำการบล็อคคุณอัตโนมัติ",
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "☝คนนี้แหล่ะคนสร้างดลุ่มนี้")
...
#==============================================================================#   
                ...
                elif msg.text in [".เปิดแทค","Tag2 on"]:
                        settings['detectMention'] = True
                        line.sendMessage(msg.to,"Respon enabled.")
                
                elif msg.text in [".ปิดแทค","Tag2 off"]:
